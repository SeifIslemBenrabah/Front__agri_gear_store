...
<div className='flex flex-row  gap-4 mr-2'>
  ...
  <table className='table-auto w-full '>
    ...
    <tr>
      <th><div className='flex justify-start text-gray text-xl font-poppins border-b-2 border-graay'>Categorie ID</div></th>
      <th><div className='flex justify-start text-gray text-xl font-poppins border-b-2 border-graay'>Name</div></th>
      <th><div className='flex justify-start text-gray text-xl font-poppins border-b-2 border-graay'>Nomber Product</div></th>
  ...
  <tbody>
    ...
    <tr>
      <td className='text-lg font-poppins font-normal'>#{Categorie.id}</td>
      <td className='text-lg font-poppins font-light'>{Categorie.name}</td>
      <td className='text-lg font-poppins font-light'>{Categorie.nomberpord}</td>
